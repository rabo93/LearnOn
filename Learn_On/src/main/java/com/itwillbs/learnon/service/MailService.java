...
//				"<a href=\"http://localhost:8081/MemberEmailAuth?mem_email="+ email + "&auth_code=" + auth_code +"\">[클릭]이메일 인증하기</a>";
		"<a href=\"http://c3d2407t1p1/MemberEmailAuth?mem_email="+ email + "&auth_code=" + auth_code +"\">[클릭]이메일 인증하기</a>";
				//주소 수정해야함
...
//					"<a href=\"http://localhost:8081/MemberEmailAuth?mem_email="+ mail + "&auth_code=" + auth_code +"\">[클릭]이메일 인증하기</a>";
			"<a href=\"http://c3d2407t1p1/MemberEmailAuth?mem_email="+ mail + "&auth_code=" + auth_code +"\">[클릭]이메일 인증하기</a>";
					//주소 수정해야함
