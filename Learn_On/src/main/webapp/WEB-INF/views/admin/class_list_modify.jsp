	                	...
	                	<div class="bg-light rounded p-4">
							...
							<div class="d-flex justify-content-between">
								<div class="col-8">
									...
									<div class="form-floating mb-3">
										<input type="text" class="form-control" id="class_intro" name="class_intro" value="${getClass.class_intro}">
										<label for="floatingInput">강의 소개</label>
									</div>
									<div class="form-floating mb-3">
										<input type="text" class="form-control" id="class_contents" style="height: 150px;" name="class_contents" value="${getClass.class_contents}"/>
